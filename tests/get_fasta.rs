...
mod testing {
    ...
    #[test]
    fn test_get_fasta_bed12() -> Result<()> {
        let input = "tests/datasets/get_fasta/unnamed.bed12";
        let fasta = "tests/datasets/get_fasta/unnamed.fa";
        let mut cmd = Command::cargo_bin("gia")?;
        let output = cmd
            .arg("get-fasta")
    ...
    #[test]
    fn test_get_fasta_named_bed12() -> Result<()> {
        let input = "tests/datasets/get_fasta/named.bed12";
        let fasta = "tests/datasets/get_fasta/named.fa";
        let mut cmd = Command::cargo_bin("gia")?;
        let output = cmd
            .arg("get-fasta")
