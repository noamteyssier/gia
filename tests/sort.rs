...
mod testing {
    ...
    #[test]
    fn test_sort_bed12() -> Result<()> {
        let input = "tests/datasets/sort/unsorted.bed12";
        let mut cmd = Command::cargo_bin("gia")?;
        let output = cmd
            .arg("sort")
            .arg("-i")
    ...
    #[test]
    fn test_lex_sort_bed12() -> Result<()> {
        let input = "tests/datasets/sort/unsorted_named.bed12";
        let mut cmd = Command::cargo_bin("gia")?;
        let output = cmd
            .arg("sort")
            .arg("-i")
    ...
    #[test]
    fn test_lex_sort_bed12_correct_name() -> Result<()> {
        let input = "tests/datasets/sort/unsorted_named.bed12";
        let mut cmd = Command::cargo_bin("gia")?;
        let output = cmd
            .arg("sort")
